...
/// </summary>
public sealed class InferenceResultModel
{
    ...
    /// <summary>A grammar to constrain the possible tokens</summary>
    public SafeLLamaGrammarHandle? Grammar { get; set; } = default;
