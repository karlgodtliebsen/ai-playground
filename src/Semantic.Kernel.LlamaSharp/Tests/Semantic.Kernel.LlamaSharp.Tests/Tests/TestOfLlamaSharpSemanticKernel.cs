...
public class TestOfLlamaSharpSemanticKernel : IAsyncLifetime
{
    ...
    public TestOfLlamaSharpSemanticKernel(LlamaSharpSemanticKernelTestFixture fixture, ITestOutputHelper output)
    {
