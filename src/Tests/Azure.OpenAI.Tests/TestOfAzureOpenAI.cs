...
public class TestOfAzureOpenAI
{
    ...
    [Fact]
    public async Task VerifyInitialAccessToEditModel()
    {
        //https://github.com/RageAgainstThePixel/OpenAI-DotNet/blob/main/OpenAI-DotNet-Tests/TestFixture_04_Edits.cs
        //https://platform.openai.com/docs/models/overview
        //v1/edits	text-davinci-edit-001, code-davinci-edit-001

        string deploymentName = "code-davinci-edit-001";

        //var request = new EditRequest("What day of the wek is it?", "Fix the spelling mistakes");

        //var result = await kwanifyOpenAiClient.EditsEndpoint.CreateEditAsync(request);
        ...
        //    }
        //};
        //var chatResponse = await openAIClient.(deploymentName, options, CancellationToken.None);
        //string message = chatResponse.Value.Choices[0].Message.Content;
        //output.WriteLine(message);
    }
    ...
    [Fact]
    public async Task VerifyInitialAccessToEmbeddingsModel()
    {
        //https://platform.openai.com/docs/models/overview
