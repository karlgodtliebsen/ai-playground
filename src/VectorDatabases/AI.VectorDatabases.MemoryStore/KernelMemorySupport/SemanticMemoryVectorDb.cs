...
public class SemanticMemoryVectorDb : ISemanticMemoryVectorDb
{
    //private readonly QdrantClient<DefaultQdrantPayload> _qdrantClient;
    //private readonly ILogger<QdrantSemanticMemory> _log;

    //public SemanticMemoryVectorDb(QdrantConfig config, ILogger<SemanticMemoryVectorDb>? log = null)
    //{
    //    this._log = log ?? DefaultLogger<SemanticMemoryVectorDb>.Instance;
    //    this._qdrantClient = new QdrantClient<DefaultQdrantPayload>(config.Endpoint, config.APIKey);
    //}

    public Task CreateIndexAsync(string indexName, int vectorSize, CancellationToken cancellationToken = new CancellationToken())
    {
        throw new NotImplementedException();
    }

    public Task<string> UpsertAsync(string indexName, MemoryRecord record, CancellationToken cancellationToken = new CancellationToken())
    {
        throw new NotImplementedException();
    }

    public IAsyncEnumerable<(MemoryRecord, double)> GetSimilarListAsync(string indexName, Embedding embedding, int limit, double minRelevanceScore = 0, ICollection<MemoryFilter>? filters = null, bool withEmbeddings = false, CancellationToken cancellationToken = new CancellationToken())
    {
        throw new NotImplementedException();
    }

    public IAsyncEnumerable<MemoryRecord> GetListAsync(string indexName, ICollection<MemoryFilter>? filters = null, int limit = 1, bool withEmbeddings = false, CancellationToken cancellationToken = new CancellationToken())
    {
        throw new NotImplementedException();
    }

    public Task DeleteIndexAsync(string indexName, CancellationToken cancellationToken = new CancellationToken())
    {
        throw new NotImplementedException();
    }

    public Task DeleteAsync(string indexName, MemoryRecord record, CancellationToken cancellationToken = new CancellationToken())
    {
        throw new NotImplementedException();
    }
