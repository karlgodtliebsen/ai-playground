...
public class SemanticMemoryVectorDb2 : ISemanticMemoryVectorDb
{

    private IQdrantClient? qdrantClient;
    private readonly IQdrantFactory qdrantFactory;
    private readonly ILogger<SemanticMemoryVectorDb2> _log;


    public SemanticMemoryVectorDb2(IQdrantFactory qdrantFactory, ILogger<SemanticMemoryVectorDb2>? log = null)
    {
        this.qdrantFactory = qdrantFactory;
        _log = log ?? DefaultLogger<SemanticMemoryVectorDb2>.Instance;
    }
